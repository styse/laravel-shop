...
class ProvincesController extends Controller
{
    ...
    {
        abort_if(FacadesGate::denies('provinces-get'), Response::HTTP_FORBIDDEN, '403 Forbidden');

        return new ProvinceResource(Province::with([])->paginate(200));
    }
    ...
    {
        abort_if(FacadesGate::denies('provinces-post'), Response::HTTP_FORBIDDEN, '403 Forbidden');
    ...
    *      ),
    ...
    {
        abort_if(FacadesGate::denies('provinces-put-delete'), Response::HTTP_FORBIDDEN, '403 Forbidden');
    ...
    {
        abort_if(FacadesGate::denies('cities-get-by-province') , Response::HTTP_FORBIDDEN, '403 Forbidden');
        $province = Province::with(['cities'])->where('id', '=', $id)->paginate();
        return new ProvinceResource($province);
    }
}
